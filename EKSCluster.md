...
# Step - 3 : Create EKS Cluster using eksctl # 
	**Syntax:** 
	...
	## N. Virgina: <br/>
	`
	eksctl create cluster --name siva-cluster4 --region us-east-1 --node-type t3.small  --zones us-east-1a,us-east-1b
	`	
	## Mumbai: <br/>
	`
	eksctl create cluster --name siva-cluster6 --region ap-south-1 --node-type t3.small  --zones ap-south-1a,ap-south-1b
	`
...
## Step - 4 : After your practise, delete Cluster and other resources we have used in AWS Cloud to avoid billing ##
	...
	```
     eksctl delete cluster --name siva-cluster4 --region us-east-1
